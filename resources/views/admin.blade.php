<x-app-layout>
    <style>
        ...
        .wb-title { font-size: clamp(1.4rem,2.5vw,2rem); font-weight: 900; color: var(--text); margin-bottom: .4rem; }
        ...
        .btn-ghost:hover { border-color: var(--blue); background: var(--blue-opacity); color:var(--text); }
        ...
        .wb-metric strong { display:block; font-size:1.6rem; font-weight:900; color:var(--text); }
        ...
        .stat-card-val   { font-size: clamp(1.8rem,2.5vw,2.6rem); font-weight:900; color:var(--text); line-height:1; }
        .stat-card-trend {
        ...
        .panel-title  { font-size:1.05rem; font-weight:800; color:var(--text); }
        .panel-badge  {
        ...
        .session-name { font-weight:700; color:var(--text); font-size:.92rem; margin-bottom:.25rem; }
    ...
    <div class="welcome-banner">
        <div>
            ...
            <p class="wb-sub">Contrôle complet sur la configuration de l'établissement.</p>
            <div class="wb-actions">
                <a href="{{ route('filieres.index') }}" class="btn-primary" style="padding:.6rem 1.2rem;font-size:.85rem;">
                    Gérer les filières
                </a>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const shared = {
            ...
            plugins: { legend: { labels: { color: getComputedStyle(document.documentElement).getPropertyValue('--muted'), usePointStyle: true, boxWidth: 10 } } }
        };
        ...
        if (donutCtx && window.Chart) {
            new Chart(donutCtx, {
                ...
                options: {
                    ...shared,
                    cutout: '70%',
                    plugins: { legend: { position: 'bottom', labels: { color: getComputedStyle(document.documentElement).getPropertyValue('--muted'), padding: 16, usePointStyle: true, font: { size: 11 } } } }
                }
            });
        }
    });
