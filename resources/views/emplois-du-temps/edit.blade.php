        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('emplois-du-temps.update', $emploiDuTemps->id) }}">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="time" name="heure_debut" id="heure_debut" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('heure_debut', $emploiDuTemps->heure_debut) }}" required>
                                @error('heure_debut')
                                    <span class="text-red-600 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="time" name="heure_fin" id="heure_fin" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('heure_fin', $emploiDuTemps->heure_fin) }}" required>
                                @error('heure_fin')
                                    <span class="text-red-600 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="salle" id="salle" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('salle', $emploiDuTemps->salle) }}" required>
                            @error('salle')
                                <span class="text-red-600 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <select name="semestre" id="semestre" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                                    ...
                                    <option value="S1" {{ old('semestre', $emploiDuTemps->semestre) == 'S1' ? 'selected' : '' }}>S1</option>
                                    <option value="S2" {{ old('semestre', $emploiDuTemps->semestre) == 'S2' ? 'selected' : '' }}>S2</option>
                                    <option value="S3" {{ old('semestre', $emploiDuTemps->semestre) == 'S3' ? 'selected' : '' }}>S3</option>
                                    <option value="S4" {{ old('semestre', $emploiDuTemps->semestre) == 'S4' ? 'selected' : '' }}>S4</option>
                                    <option value="S5" {{ old('semestre', $emploiDuTemps->semestre) == 'S5' ? 'selected' : '' }}>S5</option>
                                    <option value="S6" {{ old('semestre', $emploiDuTemps->semestre) == 'S6' ? 'selected' : '' }}>S6</option>
                                </select>
                                @error('semestre')
                                    <span class="text-red-600 text-sm">{{ $message }}</span>
                                @enderror
                            ...
                            <div>
                                ...
                                <select name="type_cours" id="type_cours" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                                    <option value="">Sélectionner</option>
                                    <option value="Cours" {{ old('type_cours', $emploiDuTemps->type_cours) == 'Cours' ? 'selected' : '' }}>Cours</option>
                                    <option value="TP" {{ old('type_cours', $emploiDuTemps->type_cours) == 'TP' ? 'selected' : '' }}>TP</option>
                                    <option value="TD" {{ old('type_cours', $emploiDuTemps->type_cours) == 'TD' ? 'selected' : '' }}>TD</option>
                                </select>
                                @error('type_cours')
                                    <span class="text-red-600 text-sm">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <select name="filiere_id" id="filiere_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                                ...
                                @foreach ($filieres as $filiere)
                                    <option value="{{ $filiere->id }}" {{ old('filiere_id', $emploiDuTemps->filiere_id) == $filiere->id ? 'selected' : '' }}>
                                        {{ $filiere->nom_filiere }}
                                    </option>
                                @endforeach
                            </select>
