        ...
        <div class="crud-container crud-container-narrow">
            <div class="crud-card">
                <div class="crud-card-body">
                    <form method="POST" action="{{ route('enseignants.store') }}" class="crud-form-grid">
                        @csrf
                        ...
                        <div>
                            ...
                            <input type="text" name="specialite" id="specialite" class="crud-input" value="{{ old('specialite') }}">
                        </div>
